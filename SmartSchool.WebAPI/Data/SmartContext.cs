...
namespace SmartSchool.WebAPI.Data
{
    public class SmartContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            this.Data ="05/28/2005";
            DateTime date = DateTime.ParseExact(Data, "MM/dd/yyyy", null);
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", date),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", date),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", date),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", date),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", date),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", date),
                    new Aluno(7, 7, "Paulo", "José", "9874512", date)
                });
